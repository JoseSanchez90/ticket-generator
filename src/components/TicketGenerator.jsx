                    ...
                    <td colSpan="7" className="p-4">
                      <div className="flex flex-col items-center">
                        ...
                        <div ref={(el) => (ticketRefs.current[index] = el)} className="relative w-[900px] h-[300px]">
                          ...
                          <div className="absolute bottom-54.5 right-25 text-black font-semibold">{person.firstName}</div>
                          <div className="absolute bottom-40 right-20 text-black font-semibold">{person.lastName}</div>
                          <div className="absolute bottom-26 right-25 text-black font-semibold">{person.address}</div> {/* Mostrar Dirección */}
